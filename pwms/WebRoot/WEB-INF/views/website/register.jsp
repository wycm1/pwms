  ...
  <form action=""  method="post" class="form form-horizontal" id="form-reward-punish-add">
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="" placeholder="" id="idcard" name="idcard" datatype="idcard" nullmsg="身份证不能为空" errormsg="身份证格式不正确">
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="" placeholder="" id="stuid" name="stuid"  datatype="stuid" nullmsg="学号不能为空" errormsg="学号格式不正确">
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="" placeholder="" id="name" name="name" datatype="*2-5" nullmsg="姓名不能为空" errormsg="姓名格式不正确">
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="" placeholder="" id="password" name="password" datatype="*6-16" nullmsg="密码不能为空" errormsg="密码在6~16位之间">
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      <label class="form-label col-3"><span class="c-red">*</span>再输一次：</label>
      <div class="formControls col-5">
        <input type="text" class="input-text" value="" placeholder="" id="password" name="password" datatype="*6-16" recheck="password" nullmsg="请再输入一次密码" errormsg="您两次输入的密码不一致">
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      <div class="col-9 col-offset-3">
        <input id="submit" class="btn btn-primary radius" type="submit" value="&nbsp;&nbsp;注册&nbsp;&nbsp;">
      </div>
    </div>
  </form>
</div>
