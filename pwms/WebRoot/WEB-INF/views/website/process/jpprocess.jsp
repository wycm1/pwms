...
<div class="nav">
	...
	<span class="c-999 en">&gt;</span><a class="maincolor" href="/pwms/process">入党流程</a>
	<span class="c-999 en">&gt;</span>入党流程
</nav>
</div>
<div class="jpprocess-wrapper">
	<div class="seven steps">
		  <span class="active step" step="1">1.递交入党申请</span>
	...
	<div class="row c1 mt-40 ml-20 mr-20">
		<div class="step-detail" con="1" style="display:block">
			<p style="text-indent: 2em; line-height: 27px; margin-top: 0px; margin-bottom: 27px; font-family: Simsun; font-size: medium; white-space: normal;">
...
<p>
    <br/>
		...
		<div class="step-detail" con="2" style="display:none">
			<p style="text-indent: 2em; line-height: 27px; margin-top: 0px; margin-bottom: 27px; font-family: Simsun; font-size: medium; white-space: normal;">
...
<p>
    <br/>
		...
		<div class="step-detail" con="3" style="display:none">
			<p style="text-indent: 2em; line-height: 27px; margin-top: 0px; margin-bottom: 27px; font-family: Simsun; font-size: medium; white-space: normal;">
...
<p>
    <br/>
		...
		<div class="step-detail" con="4" style="display:none">
			<p style="text-indent: 2em; line-height: 27px; margin-top: 0px; margin-bottom: 27px; font-family: Simsun; font-size: medium; white-space: normal;">
...
<p>
    <br/>
		...
		<div class="step-detail" con="5" style="display:none">
					<p style="text-indent: 2em; line-height: 27px; margin-top: 0px; margin-bottom: 27px; font-family: Simsun; font-size: medium; white-space: normal;">
		    1、 成为发展对象程序：
		</p>
		<p style="text-indent: 2em; line-height: 27px; margin-top: 0px; margin-bottom: 27px; font-family: Simsun; font-size: medium; white-space: normal;">
		...
		<div class="step-detail" con="6" style="display:none">
				<p style="text-indent: 2em; line-height: 27px; margin-top: 0px; margin-bottom: 27px; font-family: Simsun; font-size: medium; white-space: normal;">
    1、 成为预备党员的程序
</p>
<p style="text-indent: 2em; line-height: 27px; margin-top: 0px; margin-bottom: 27px; font-family: Simsun; font-size: medium; white-space: normal;">
    　　经上级党组织同意后发展对象填写《入党志愿书》→支委会对发展对象填写的《入党志愿书》和有关情况进行严格审查，经集体讨论→合格→支部大会讨论决议→报党总支审批→党委组织部聘请的组织员与申请人谈话→经党总支委员会审批、总支书记签字盖章后的入党材料由总支报学校党委组织部→校党委常委会审批→通过后→申请人被正式接收为中共预备党员并补交党费，入党时间从支部大会之日算起
</p>
<p style="text-indent: 2em; line-height: 27px; margin-top: 0px; margin-bottom: 27px; font-family: Simsun; font-size: medium; white-space: normal;">
    2、 支部大会程序
</p>
...
<p>
    <br/>
		...
		<div class="step-detail" con="7" style="display:none">
			<p style="text-indent: 2em; line-height: 27px; margin-top: 0px; margin-bottom: 27px; font-family: Simsun; font-size: medium; white-space: normal;">
    1、转正期间需要做的工作：
</p>
<p style="text-indent: 2em; line-height: 27px; margin-top: 0px; margin-bottom: 27px; font-family: Simsun; font-size: medium; white-space: normal;">
