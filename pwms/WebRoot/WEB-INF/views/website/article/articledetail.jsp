...
<div class="page-main pb-20">
	<div class="nav radius">
		...
		<span class="c-999 en">&gt;</span><a class="maincolor" href="${article.articletype.pArticletype.linkname}">${article.articletype.pArticletype.value}</a>
		<span class="c-999 en">&gt;</span><a class="maincolor" href="${article.articletype.pArticletype.linkname}/${article.articletype.linkname}/list.html">${article.articletype.value}</a>
	...
	<div class="col-xs-12 col-sm-2 radius">
		<ul class="upright-menu">
			<c:forEach items="${cArticletypeList}" var="item">
				<li> <a href="${article.articletype.pArticletype.linkname}/${item.linkname}/list.html">${item.value}</a></li>
			</c:forEach>
		</ul>
	</div>
