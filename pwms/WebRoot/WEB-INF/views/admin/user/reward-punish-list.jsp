...
<div class="pd-20">
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="user/exportXlsReward" class="btn btn-primary radius">导出奖惩记录表</a> <a href="javascript:;" onclick="member_add('添加奖惩登记记录','reward-punish-add.html','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加奖惩记录</a></span> <span class="r">共有数据：<strong>88</strong> 条</span> </div>
	<div class="mt-20">
