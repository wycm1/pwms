...
<body>
<div class="pd-20">
	<form action="admin/article/updatearticle" method="post" class="form form-horizontal" id="form-article-add">
		<div class="row cl">
...
<script type="text/javascript" src="<%=basePath %>res/lib/jquery/1.9.1/jquery.min.js"></script> 
...
$(function(){
	...
	ue.ready(function() {
	    ue.setContent('${article.contents}');
	});
});
