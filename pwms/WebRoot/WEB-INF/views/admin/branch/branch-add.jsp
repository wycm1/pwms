...
<body>
<div class="pd-20">
  <form action="admin/branch/addbranch"  method="post" class="form form-horizontal" id="form-branch-add">
    <div class="row cl">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" name="branchName" id="branchName" datatype="*" nullmsg="请输入奖惩名称！">
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
